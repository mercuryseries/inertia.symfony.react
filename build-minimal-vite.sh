...
function inertia.symfony.react {
    ...
    composer require twig-bundle pentatrion/vite-bundle:^3.3 serializer debug process
    ...
    cat ./stubs/stubs/gitignore-vite > .gitignore
    ...
    cat ./stubs/stubs/Layout-minimal-vite.jsx > assets/js/components/Layout.jsx
